...
typedef enum {
	...
	NVIC_WWDG_INT 							= 0,
	NVIC_PVD_and_EXTI16_INT 				= 1,
	NVIC_TAMP_STAMP_and_EXTI21_INT			= 2,
	NVIC_RTC_WKUP_and_EXTI22_INT			= 3,
	NVIC_FLASH_INT							= 4,
	NVIC_RCC_INT							= 5,
	NVIC_EXTI0_INT							= 6,
	NVIC_EXTI1_INT							= 7,
	...
	NVIC_RTC_Alarm_and_EXTI17_INT			= 41,
	NVIC_OTG_FS_WKUP_and_EXTI18_INT			= 42,
