...
#define SD_CARD_COMAND_0_ERORR 0xF0
#define  SD_CARD_COMAND_8_ERORR 0xF1
#define SD_CARD_COMAND_55_ERORR 0xF2
#define SD_CARD_CMD17_DATA_TOKEN_ERROR 0xF3

#define SD_CARD_READ_BLOCK_ERROR 1
